      ...
      <Container>
        <Box
          ...
          <Grid container spacing={2}>
            <Grid item sx={{ my: "auto" }} xs={6} md={8}>
              ...
              {!isLoading && <form  >
                ...
                <Button sx={{ width: "70%" }} onClick={handleSubmit(onSubmit)} variant="contained">Register</Button>
                <p>or</p>
                <Button sx={{ my: 2, width: "70%" }} variant="contained">  Sign With google</Button>
                <NavLink to="/signin"> <Button variant="contained">Already have an account? SignIn Here</Button></NavLink>
              </form>}
              {
